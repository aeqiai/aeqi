      ...
      <div className="max-w-xl mx-auto text-center">
        <motion.div {...fadeView()}>
          ...
          <p className="text-[15px] text-black/40 mb-10">
            Host it yourself. Own your infrastructure.
          </p>
        </motion.div>
        ...
        <motion.div {...fadeView(0.1)} className="flex flex-col items-center gap-0 mb-10 w-full max-w-md mx-auto">
          ...
          <button
            onClick={() => { navigator.clipboard.writeText("curl -fsSL https://raw.githubusercontent.com/aeqiai/aeqi/main/scripts/install.sh | sh"); setCopied(true); setTimeout(() => setCopied(false), 2000); }}
