...
function GoogleIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M22.5 12.27c0-.79-.07-1.54-.2-2.27H12v4.51h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.55c2.08-1.92 3.28-4.74 3.28-8.33z" />
      <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.55-2.77c-.98.66-2.24 1.06-3.73 1.06-2.87 0-5.3-1.94-6.17-4.55H2.18v2.86A11 11 0 0 0 12 23z" />
      <path d="M5.83 14.08a6.6 6.6 0 0 1 0-4.16V7.06H2.18a11 11 0 0 0 0 9.88l3.65-2.86z" />
      <path d="M12 5.38c1.62 0 3.07.56 4.21 1.65l3.16-3.16C17.46 2.07 14.97 1 12 1A11 11 0 0 0 2.18 7.06l3.65 2.86C6.7 7.32 9.13 5.38 12 5.38z" />
    </svg>
  );
}
