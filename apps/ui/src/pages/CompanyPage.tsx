...
/**
 * /c/:entityId[/:tab] — the company-scoped surface.
 *
 * Two-column page-rail-shell mirroring `/economy`: the left rail lists
 * the company's primitives (Overview / Positions), the right pane
 * renders whichever tab AgentPage already knows how to draw. Sub-tab
 * navigation is owned here so the global LeftSidebar carries one
 * "Company" item, not six.
 */
