 ...
 * IDL can be found at `target/idl/aeqi_company.json`.
 */
export type AeqiCompany = {
  "address": "CCbs4TCqE6FXmRdyLexx2rSSHAShymWrrR9QWeJUJbXV",
  "metadata": {
    "name": "aeqiCompany",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "AEQI core protocol — COMPANY registry, ACL flags, config store, execute gateway"
  },
  "instructions": [
    {
