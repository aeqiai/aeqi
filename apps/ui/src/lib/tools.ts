...
export const ALL_TOOLS: ToolSpec[] = [
  ...
  },
  {
    ...
    category: "aeqi",
    description:
      "When enabled, this agent can fire question.ask to surface a question in your pinned My sessions view. Off by default - flip on for agents you company to ask sparingly.",
  },
  {
    id: "code",
    label: "Code",
