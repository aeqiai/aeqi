...
import TrustSetupPage from "@/pages/TrustSetupPage";
...
describe("TrustSetupPage", () => {
  beforeEach(() => {
    ...
    startLaunch.mockResolvedValue({ trust_id: "ent_sandbox" });
