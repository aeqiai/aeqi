...
export interface TrustAvatarProps {
...
/**
 * TrustAvatar — canonical render for a TRUST's visual identity.
 *
 * When the TRUST has a custom image (`src`), that fills the rounded-
