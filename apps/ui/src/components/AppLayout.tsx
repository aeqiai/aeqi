        ...
        <div className="left-sidebar">
          ...
          <nav className="sidebar-nav">
            ...
            <a className={`sidebar-nav-item ${isActive("/quests") ? "active" : ""}`} href="/quests" onClick={(e) => { e.preventDefault(); navigate("/quests"); }}>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.3"><path d="M4 3h8M4 7h8M4 11h6M2 3v0.3.8v0M2 11v0" strokeLinecap="round" /></svg>
          ...
          <div className="sidebar-footer">
            ...
            <span className="sidebar-footer-version">v0.3.8</span>
          </div>
        </div>
