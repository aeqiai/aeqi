...
import type { CompanyEmailIdentitySummary } from "./CompanyPrimitiveApps";
...
export function NewMailModal({
  ...
  domain: string;
  existing: CompanyEmailIdentitySummary[];
  onClose: () => void;
  ...
  return (
    <Modal open={open} onClose={onClose} title="New Mailbox">
      <form className="company-apps-modal-form" onSubmit={submit}>
        <Input
          label="Local part"
          value={localPart}
        ...
        />
        <div className="company-apps-address-preview">
...
export function NewWebsiteModal({
  ...
  return (
    <Modal open={open} onClose={onClose} title="New Website">
      <form className="company-apps-modal-form" onSubmit={handleSubmit}>
        <Input
          label="Domain"
          value={domain}
