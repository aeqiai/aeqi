...
export default function CompanyToolsTab({ agentId }: { agentId: string }) {
  ...
  return (
    <div className="company-tools-page company-primitive-shell">
      {toast && (
        <div
      ...
      <PrimitivePageHeader
        className="company-tools-page-header company-primitive-shell-header"
        title={
          <span className="company-primitive-page-title">
            <span className="company-primitive-page-title-text">Tools</span>
      ...
      >
        <div className="ideas-toolbar company-tools-toolbar">
      ...
      <main
        className="company-tools-main company-tools-page-body company-primitive-shell-surface"
        aria-label="Company tools"
      >
        <section className="company-tools-register company-tools-card" aria-label="Tool register">
          <div className="company-tools-register-head">
            <div>
              <p className="company-tools-register-kicker">Default agent</p>
              <h2 className="company-tools-register-title">{agent?.name ?? "No agent assigned"}</h2>
            </div>
            <dl className="company-tools-register-stats" aria-label="Tool policy summary">
              <div>
                <dt>On</dt>
                <dd>{activeCount}</dd>
              </div>
          ...
          {resolvedAgentId ? (
            <AgentToolSettings
              agent={agent}
              className="company-tools-list"
              resolvedAgentId={resolvedAgentId}
              showToast={showToast}
              titleId="company-tools-title"
              showHeader={false}
              showSummary={false}
              tools={visibleTools}
              emptyState={
                <div className="company-tools-state">
            ...
            <div className="company-tools-state company-tools-state--empty">
              Tool access is available after this company has an agent.
            </div>
          )}
        </section>
      </main>
