...
export default function CompanyIntegrationCreateModal({
  connecting,
  onClose,
  onEtsy,
  onGateway,
  ...
  return (
    <Modal open={open} onClose={onClose} title="New Integration">
      <div className="company-apps-provider-list">
        <ProviderAction
...
function ProviderAction({
  ...
  return (
    <CardTrigger
      className="company-apps-provider-row"
      onClick={onClick}
      disabled={disabled || loading}
    >
      <span className="company-apps-provider-icon" aria-hidden>
        {icon}
      </span>
      <span className="company-apps-provider-copy">
        <span className="company-apps-provider-title">{title}</span>
        <span className="company-apps-provider-subtitle">{subtitle}</span>
      </span>
      <span className="company-apps-provider-action">{loading ? "Connecting" : action}</span>
    </CardTrigger>
  );
}
