...
1. **Recall recent entity memories** — use insights_recall with scope "entity" to review your recent experiences, decisions, and outcomes.
...
3. **Write a journal entry** — use insights_store with scope "entity" to save a dated reflection. Key format: `evolution:{date}`. Category: "evergreen".
