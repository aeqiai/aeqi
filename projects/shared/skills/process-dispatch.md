...
tools: [agents_delegate, insights_recall, insights_store, shell, read_file, glob, grep, write_file, edit_file]
tags: [autonomous]
---
...
4. **Share** — store findings via `insights_store` if useful beyond this quest.
