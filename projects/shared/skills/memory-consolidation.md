...
1. **Recall all entity memories** — use memory_recall with scope "entity", broad query like "all recent knowledge and experiences". Also recall domain memories for your project.
...
3. **Consolidate** — for each cluster of related/redundant memories:
   - Write ONE clean consolidated entry via memory_store
