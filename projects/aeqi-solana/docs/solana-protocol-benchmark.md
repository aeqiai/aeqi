...
The benchmark defines the quality floor. The AEQI product ceiling is defined in
`docs/evm-to-solana-essence-map.md`, which maps the original EVM company OS
design into the Solana implementation.
