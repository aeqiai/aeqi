...
- `architecture.md` -- system map, crates, primitives, agent loop
- `context-injection.md` -- how agent input context is assembled per quest
- `deployment.md` -- production topology, systemd, reverse proxy
- `quickstart.md` -- local setup for daemon, API, and UI
- `platform-architecture.md` -- multi-tenant SaaS and open-source kernel
