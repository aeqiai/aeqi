...
impl PrometheusObserver {
    ...
    pub fn render(&self) -> String {
        format!(
            "# HELP aeqi_agent_starts_total Total agent starts\n\
             # TYPE aeqi_agent_starts_total counter\n\
             aeqi_agent_starts_total {}\n\
             # HELP aeqi_agent_ends_total Total agent completions\n\
             # TYPE aeqi_agent_ends_total counter\n\
             aeqi_agent_ends_total {}\n\
             # HELP aeqi_llm_requests_total Total LLM requests\n\
             # TYPE aeqi_llm_requests_total counter\n\
             aeqi_llm_requests_total {}\n\
             # HELP aeqi_llm_prompt_tokens_total Total prompt tokens\n\
             # TYPE aeqi_llm_prompt_tokens_total counter\n\
             aeqi_llm_prompt_tokens_total {}\n\
             ...
             # HELP aeqi_tool_errors_total Total tool errors\n\
             # TYPE aeqi_tool_errors_total counter\n\
             aeqi_tool_errors_total {}\n\
             # HELP aeqi_tool_duration_ms_total Total tool execution time in ms\n\
             # TYPE aeqi_tool_duration_ms_total counter\n\
             aeqi_tool_duration_ms_total {}\n",
